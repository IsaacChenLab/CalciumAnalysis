...
% FC_method: set to 'raw' to run raw trace method for FC -- otherwise FLUROSNNAP default method will be used
% FC_inactive: set to 'include inactive' to include cells without events in FC analysis -- otherwise those cells will be ignored
% FC_islands: set to 'remove islands' to remove from network any cell that has no edges
